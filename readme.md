...
说明：新版的沉浸式翻译扩展已经迁移到[这里](https://github.com/Myasuka/my-immersive-translate)，新版全新架构，性能更好，支持更多的翻译引擎和浏览器平台（包括iOS Safari），以及拥有更好的pdf翻译体验，欢迎移步[新版](https://github.com/Myasuka/my-immersive-translate)。旧版代码将存档。
...
[![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/Myasuka/my-immersive-translate?label=latest%20version&sort=semver)](https://github.com/Myasuka/my-immersive-translate/releases)
[![GitHub release date](https://img.shields.io/github/release-date/Myasuka/my-immersive-translate?labely)](https://github.com/Myasuka/my-immersive-translate/latest)
[![GitHub issues](https://img.shields.io/github/issues/Myasuka/my-immersive-translate?color=red)](https://github.com/Myasuka/my-immersive-translate/issues)
[![GitHub license](https://img.shields.io/github/license/Myasuka/my-immersive-translate?color=lightgrey)](https://github.com/Myasuka/my-immersive-translate/blob/master/LICENSE)
...
- 为常用网站做了定制优化，比如Twitter，Reddit，Discord, Telegram, Youtube, Hacker News等。我希望这个扩展足够通用，不需要为绝大多数网站做定制，但是往往有一些网站由于不规范，或者非内容类网站，这些网站在单独优化后体验更好，所以我们会对这类网站做单独适配，同时坏处就是可能随时因网站的更新而失效，所以这里我会持续优化。如果有常用的网站翻译显示不佳，欢迎在[Isuee](https://github.com/Myasuka/my-immersive-translate/issues)或[Telegram群组](https://t.me/+rq848Z09nehlOTgx)中提出。
...
本项目的[Wiki页面](https://github.com/Myasuka/my-immersive-translate/wiki)下有更多使用帮助信息。

## 安装说明

### Firefox 

已发布到商店，可以[直接下载](https://addons.mozilla.org/en-US/firefox/addon/immersive-translate/)。如果你想最快体验到新版，也可以直接在[Release页面](https://github.com/Myasuka/my-immersive-translate/releases)下载最新构建的版本，已签名，可以直接安装。
...
Chrome商店审核会有延迟，如果你想最快体验新版，可以直接在[Release页面](https://github.com/Myasuka/my-immersive-translate/releases)下载最新的版本：

1. 在[这里](https://github.com/Myasuka/my-immersive-translate/releases)下载chrome的压缩包
2. 解压到一个以后不会删除的文件夹
...
除了下载Release页面构建好的版本之外，你还可以通过Clone本项目，然后随着本项目的更新，每次都`git pull`最新代码，然后在本地手动构建: `npm run build`, 然后在扩展管理窗口，里加载 `dist/chrome`文件夹即可。点击[这里](https://github.com/Myasuka/my-immersive-translate/wiki/Chrome-Firefox-%E6%89%8B%E5%8A%A8%E6%9E%84%E5%BB%BA%E6%9C%80%E6%96%B0%E7%89%88%E6%9C%AC)查看更详细的步骤。
...
在[Release页面](https://github.com/Myasuka/my-immersive-translate/releases)会有一个nightly版本被频繁的构建，建议喜欢体验最新版/或者想帮忙测试的同学，可以手动安装nightly版本，firefox的扩展包已签名，可以直接下载后作为扩展文件安装。
...
目前已有的规则见[这里](https://github.com/Myasuka/my-immersive-translate/blob/main/src/lib/specialRules.js)
...
更多说明请在[页面规则配置](https://github.com/Myasuka/my-immersive-translate/wiki/Special-Rules-Tutorial) Wiki查看。
...
更多截图请在[Wiki页面](https://github.com/Myasuka/my-immersive-translate/wiki/Screenshot-for-sites)查看
...
你可以在本项目的[Wiki页面](https://github.com/Myasuka/my-immersive-translate/wiki)查看更多文档以及常见问题。
...
1. Download [the latest release chrome file](https://github.com/Myasuka/my-immersive-translate/releases/)
...
- I hope this plugin is universal enough that it does not need to be customized for most websites, but there are often some websites that are not standardized, or non-content websites, and these websites are better after separate optimization, so we will do separate adaptations for such websites, and the downside is that the website may not work at any time. The bad thing is that the website may fail at any time with the update of the website, so here I will continue to optimize. If you have a commonly used website that does not translate well, please feel free to ask in [Isuee](https://github.com/Myasuka/my-immersive-translate/issues) or [Telegram group](https://t.me/+rq848Z09nehlOTgx ).
